        ...
        body: SingleChildScrollView(
          child : Column(children: [
            Padding(
              ...
              child: Text("SELAMAT DATANG",style: DefaultTextStyle.of(context).style.apply(fontSizeFactor: 1.0)),
            ),
            LogoImageAssets(),
            _usernameField(),
            _passwordField(),
...
class LogoImageAssets extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    AssetImage assetImage = const AssetImage('assets/image/img.png');
